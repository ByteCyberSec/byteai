# ByteAi Intelligence Engine — /Ideas and /Github Commands

ByteAI's `/Ideas` and `/Github` commands implement the full ByteAi intelligence
...
Then compare against existing ByteAi skills. Possible actions:
...
Core ByteAi principle: do not install thousands of skills ahead of time.
...
2. **Local**: `.byteai/intelligence/` in the project working directory —
...
↓
COMPATIBILITY SCORE (ByteAi 0–100, project 0–100, complexity, risk)
↓
